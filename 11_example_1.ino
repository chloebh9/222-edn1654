...
void loop() {
  ...
  dist_raw = USS_measure(PIN_TRIG, PIN_ECHO); // read 
  ...
  }else if(180 < dist_ema && dist_ema < 360){
//    myservo.writeMicroseconds(_DUTY_NEU);
    myservo.writeMicroseconds((dist_ema - 180) * (_DUTY_MAX - _DUTY_MIN) / 180 + _DUTY_MIN);
  }else {
