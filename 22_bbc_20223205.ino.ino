...
// Servo adjustment
#define _DUTY_MAX 2000  // Servo angle: D degree  //2100
#define _DUTY_NEU 1400  // Servo angle: 0 degree  //1500
#define _DUTY_MIN 800   // Servo angle: E degree  //900
#define _SERVO_ANGLE_DIFF 90 // Replace with |D - E| degree
#define _SERVO_SPEED 250 // servo speed limit (unit: degree/second)

#define _BANGBANG_RANGE 220   //150
...
// Replace the below line with the equation obtained from nonlinear regression analysis
  return 1446 + -8.2 * a_value + 0.0163 * a_value * a_value + -1.1E-05 * a_value *a_value * a_value;
}
